...
public class Names {
    ...
    private static String[] interests = {"Reading", "Cooking", "Traveling", "Photography", "Gardening", "Music", "Movies", "Sports", "Art", "Writing", "Technology", "Fashion", "Gaming", "Fitness"};
    //{"Reading", "Cooking", "Traveling", "Photography", "Gardening", "Music", "Movies", "Sports", "Art", "Writing", "Technology", "Fashion", "Gaming", "Fitness", "Dancing", "Hiking", "Fishing", "Cycling", "Swimming", "Running", "Bird Watching", "Yoga", "Collecting", "Painting", "Sculpture", "Knitting", "Crafting", "Camping", "Podcasts", "Podcasting", "Volunteering", "Learning Languages", "Fishing", "Astronomy", "Baking", "Birdwatching", "Meditation", "Science", "History", "Philosophy", "Anthropology", "Social Media", "Makeup", "Skincare", "Jewelry Making", "Chess", "Board Games", "Card Games", "Interior Design", "Home Improvement", "Cars", "Motorcycles", "Boating", "Climbing", "Skiing", "Snowboarding", "Ice Skating", "Surfing", "Skateboarding", "Snowshoeing", "Running Marathons", "Cycling Tours", "Public Speaking", "Entrepreneurship", "Investing", "Stock Market", "Cryptocurrency", "Writing Blogs", "Editing", "Podcasts Listening", "Documentaries", "Journaling", "Self-improvement", "Business Strategy", "Video Editing", "3D Modeling", "Coding", "App Development", "Web Design", "Cybersecurity", "Machine Learning", "Data Science", "Robotics", "Artificial Intelligence", "Blockchain", "Smart Homes", "Drone Flying", "Geocaching", "Aquarium Keeping", "Herpetology", "Reptile Keeping", "Photography", "Urban Exploration", "Travel Blogging", "Dungeons & Dragons", "Tabletop RPGs", "LARPing", "Magic Tricks", "Puzzles", "Escape Rooms", "Concerts", "Music Festivals", "Theater", "Comics", "Graphic Novels", "Anime", "Manga", "Fanfiction", "DIY Projects", "Home Brewing", "Vlogging"};
